...
namespace WpfApp7.EfContext
{
    public class DataContext : DbContext
    {
        ...
        {
            modelBuilder.Entity<Departament>().HasData(new Departament { Id = Guid.Parse("D3C376E4-BCE3-4D85-ABA4-E3CF49612C94"), Name = "IT отдел" });
            modelBuilder.Entity<Departament>().HasData(new Departament { Id = Guid.Parse("131EF84B-F06E-494B-848F-BB4BC0604266"), Name = "Бухгалтерия" });
            modelBuilder.Entity<Departament>().HasData(new Departament { Id = Guid.Parse("8DCC3969-1D93-47A9-8B79-A30C738DB9B4"), Name = "Служба безопасности" });
            modelBuilder.Entity<Departament>().HasData(new Departament { Id = Guid.Parse("D2469412-0E4B-46F7-80EC-8C522364D099"), Name = "Отдел кадров" });
            modelBuilder.Entity<Departament>().HasData(new Departament { Id = Guid.Parse("1EF7268C-43A8-488C-B761-90982B31DF4E"), Name = "Канцелярия" });
            modelBuilder.Entity<Departament>().HasData(new Departament { Id = Guid.Parse("415B36D9-2D82-4A92-A313-48312F8E18C6"), Name = "Отдел продаж" });
            modelBuilder.Entity<Departament>().HasData(new Departament { Id = Guid.Parse("624B3BB5-0F2C-42B6-A416-099AAB799546"), Name = "Юридическая служба" });
        }
